...
my $version = "0.5";
my $command_suffix = " &>/dev/null &";

# default values in setup file (~/.weechat/plugins.rc)
my $default_cmd_highlight = "aplay ~/Sounds/highlight.wav";
my $default_cmd_pv        = "aplay ~/Sounds/private.wav";
my $default_cmd_ctcp      = "aplay \$filename";
